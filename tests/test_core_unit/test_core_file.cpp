...
struct test_file_1_t: public test_t {

    test_file_1_t()
        : test_t("test_file_1_t")
    {
    }
...
struct test_file_2_t: public test_t {

    test_file_2_t()
        : test_t("test_file_2_t")
    {
    }
...
struct test_file_3_t: public test_t {

    test_file_3_t()
        : test_t("test_file_3_t")
    {
    }
...
struct test_file_4_t: public test_t {

    test_file_4_t()
        : test_t("test_file_4_t")
    {
    }
